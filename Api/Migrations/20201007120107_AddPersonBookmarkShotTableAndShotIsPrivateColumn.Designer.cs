...
namespace Api.Migrations
{
    ...
    [Migration("20201007120107_AddPersonBookmarkShotTableAndShotIsPrivateColumn")]
    partial class AddPersonBookmarkShotTableAndShotIsPrivateColumn
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasAnnotation("Relational:Sequence:.RefreshTokenHiLoSequence", "'RefreshTokenHiLoSequence', '', '1', '10', '', '', 'Int64', 'False'")
            ...
            modelBuilder.Entity("Api.Data.Models.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        ...
                        .HasColumnName("id")
                        .HasColumnType("bigint")
                        .HasAnnotation("Npgsql:HiLoSequenceName", "RefreshTokenHiLoSequence")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SequenceHiLo);
            ...
            modelBuilder.Entity("Api.Data.Models.Relationships.PersonBookmarkShot", b =>
                {
                    b.Property<long>("PersonId")
                        .HasColumnName("person_id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("person_bookmark_shot");
                });
            ...
            modelBuilder.Entity("Api.Data.Models.Relationships.PersonBookmarkShot", b =>
                {
                    b.HasOne("Api.Data.Models.Person", "Person")
                        .WithMany("BookmarkShots")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Data.Models.Shot", "Shot")
                        .WithMany("PersonBookmarks")
                        .HasForeignKey("ShotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
